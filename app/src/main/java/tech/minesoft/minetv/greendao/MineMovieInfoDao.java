...
public class MineMovieInfoDao extends AbstractDao<MineMovieInfo, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Vod_reverse = new Property(2, Integer.class, "vod_reverse", false, "VOD_REVERSE");
        public final static Property Star_time = new Property(3, java.util.Date.class, "star_time", false, "STAR_TIME");
        public final static Property Last_open = new Property(4, java.util.Date.class, "last_open", false, "LAST_OPEN");
        public final static Property Api_url = new Property(5, String.class, "api_url", false, "API_URL");
        public final static Property Api_code = new Property(6, String.class, "api_code", false, "API_CODE");
        public final static Property Api_name = new Property(7, String.class, "api_name", false, "API_NAME");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MINE_MOVIE_INFO\" (" + //
                ...
                "\"VOD_REVERSE\" INTEGER," + // 2: vod_reverse
                "\"STAR_TIME\" INTEGER," + // 3: star_time
                "\"LAST_OPEN\" INTEGER," + // 4: last_open
    ...
    public MineMovieInfo readEntity(Cursor cursor, int offset) {
        MineMovieInfo entity = new MineMovieInfo( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getInt(offset + 2), // vod_reverse
            cursor.isNull(offset + 3) ? null : new java.util.Date(cursor.getLong(offset + 3)), // star_time
            cursor.isNull(offset + 4) ? null : new java.util.Date(cursor.getLong(offset + 4)), // last_open
            cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5), // api_url
            cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6), // api_code
            cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7), // api_name
    ...
    public void readEntity(Cursor cursor, MineMovieInfo entity, int offset) {
        ...
        entity.setVod_reverse(cursor.isNull(offset + 2) ? null : cursor.getInt(offset + 2));
        entity.setStar_time(cursor.isNull(offset + 3) ? null : new java.util.Date(cursor.getLong(offset + 3)));
        entity.setLast_open(cursor.isNull(offset + 4) ? null : new java.util.Date(cursor.getLong(offset + 4)));
        entity.setApi_url(cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5));
        entity.setApi_code(cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6));
        entity.setApi_name(cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7));

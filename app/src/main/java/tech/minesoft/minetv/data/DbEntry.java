...
public class DbEntry {
    ...
    public static final String RECORD_VOD_REVERSE = "vod_reverse";
    ...
    public static final String SQL_CREATE_RECORD =
            " CREATE TABLE IF NOT EXISTS " + TABLE_RECORD + " ( " +
                    RECORD_ID + " INTEGER " + "constraint " + TABLE_RECORD + "_pk PRIMARY KEY autoincrement, " +
                    RECORD_TYPE + " INTEGER, " +
                    RECORD_VOD_ID + " INTEGER, " +
                    RECORD_VOD_INFO + " TEXT, " +
                    RECORD_VOD_REVERSE + " INTEGER) ";
    ...
    public static final String SQL_1 = "alter table " + TABLE_RECORD + " add " + RECORD_VOD_REVERSE + " INTEGER";
}
